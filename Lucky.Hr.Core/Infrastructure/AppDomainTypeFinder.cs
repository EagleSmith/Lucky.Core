...
namespace Lucky.Hr.Core.Infrastructure
{
    /// <summary>
    /// 发现需要NOP通过在循环组件类型的类 
    /// 当前正在执行的AppDomain。只有组件，其名称匹配 
    /// 某些模式进行了研究和组件的可选列表 
    /// 通过<see cref="AssemblyNames"/>引用总是调查
    /// </summary>
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>创建AppDomainTypeFinder的新实例</summary>
        ...
        /// <summary>获取或设置羯羊NOP NOP加载类型时，应重复组件的应用程序域中。这些加载程序集时装载模式被应用</summary>
        ...
        /// <summary>获取或设置组件除了那些在AppDomain中加载的加载启动</summary>
        ...
        /// <summary>或者或者设置为我们知道不需要进行加载的 DLL</summary>

...
namespace Lucky.Hr.Web.Framework.Themes
{
    public class ThemeViewEngine : RazorViewEngine
    {
        ...
        protected virtual string GetPath(ControllerContext controllerContext, string[] locations, string[] areaLocations, string locationsPropertyName, string name, string controllerName, string cacheKeyPrefix, bool useCache, out string[] searchedLocations)
        {
            ...
            if (!string.IsNullOrEmpty(areaName) && areaName.Equals("SiteManager", StringComparison.InvariantCultureIgnoreCase))
            {
                var newLocations = areaLocations.ToList();
                newLocations.Insert(0, "~/SiteManager/Views/{1}/{0}.cshtml");
                newLocations.Insert(0, "~/SiteManager/Views/{1}/{0}.vbhtml");
                newLocations.Insert(0, "~/SiteManager/Views/Shared/{0}.cshtml");
                newLocations.Insert(0, "~/SiteManager/Views/Shared/{0}.vbhtml");

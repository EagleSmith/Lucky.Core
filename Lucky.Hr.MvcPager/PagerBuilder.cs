...
namespace LiteCode.MvcPager
{
    internal class PagerBuilder
    {
        ...
        internal MvcHtmlString RenderPager()
        {
            ...
            tb.InnerHtml = "<ul class='pagination pagination-sm m-t-sm m-b-none'>" + sb.ToString() + "</ul>";
            /* 注册客户端脚本
        ...
        private string BuildGoToPageSection()
        {
            ...
            if (_pagerOptions.PageIndexBoxType == PageIndexBoxType.DropDownList)
            {
                ...
                piBuilder.AppendFormat(
                    "<input type=\"text\" value=\"{0}\" style=\"\" class=\"input-small\" data-pageindexbox=\"true\"{1}/>", _pageIndex, (_pagerOptions.ShowGoButton ? "" : " data-autosubmit=\"true\""));
            string outHtml;
            ...
            {
                piBuilder.AppendFormat("<input type=\"button\" class=\"btn btn-mini\" data-submitbutton=\"true\" value=\"{0}\"/>", _pagerOptions.GoButtonText);
            }

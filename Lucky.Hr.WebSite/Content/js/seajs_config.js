...
seajs.config({
    paths: {
        'dist': www_head + '/Content/js/' + dist,
        'assets': www_head + '/Content',
        'style': www_head + '/Content/css',
        'app': www_head + '/Content/js',
        'jquery': www_head + '/Content/js/sea-modules/jquery',
        'bootstrap': www_head + '/Content/js/sea-modules/bootstrap'
    },
    alias: {
        ...
        'unobtrusive':'jquery/jquery.validate.unobtrusive.js'
    },
    preload: ['$', 'bootstrap'],
    map: [

...
using Owin;
[assembly: OwinStartup(typeof(Lucky.Hr.WebSite.Startup))]
namespace Lucky.Hr.WebSite
{
    public partial class Startup
	{
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(HrDbContext.Create);
            ...
            app.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                ...
                LoginPath = new PathString("/SiteManager/Account/Login"),
                Provider = new CookieAuthenticationProvider
                {
                    // 当用户登录时使应用程序可以验证安全戳。
                    // 这是一项安全功能，当你更改密码或者向帐户添加外部登录名时，将使用此功能。
                    OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<ApplicationUserManager, Manager>(
